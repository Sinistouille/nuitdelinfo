...
<div id="consentBox">
    ...
    <div id="consentContent">
        ...
        <p id="cookie_para">
            ...
            {:else}
            Pour garantir votre sécurité et améliorer votre expérience, nous vous demandons de cliquer 100 fois sur le cookie. Ce processus assure que vous soyez sûr(e) de refuser les avantages que vous apportent les cookies.
            <br>
