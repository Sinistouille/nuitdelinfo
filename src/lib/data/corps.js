...
export const organes = [
...

	{
		...
		title: 'La Rate',
		content:
			`<p>La rate, cet organe discret et souvent méconnu, joue pourtant un rôle essentiel dans le fonctionnement du corps humain. Elle filtre le sang, recycle les globules rouges usés et aide à défendre l’organisme contre les infections. Dans le cadre d’un parallèle, on pourrait comparer la rate à l’océan dans son rôle de “filtre planétaire”.</p>
...

	{
		...
		title: 'Les Intestins',
		content:
			`<p>L’intestin est l’organe central du système digestif du corps humain. Il est particulièrement multitâche : les aliments arrivent bruts, et l’intestin les décompose en éléments plus simples et absorbables par le sang. Il laisse au contraire les éléments inutiles et toxiques être évacués du corps humain.</p>
...

	{
		...
		title: 'Le Cerveau',
		content:
			`<p>Le cerveau est le centre de contrôle du corps humain, traitant l'information et envoyant des signaux pour coordonner les fonctions des organes et des systèmes. Il utilise des réseaux de neurones pour transmettre des signaux électriques, garantissant une communication efficace dans tout le corps.</p>
